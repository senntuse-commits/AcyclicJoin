#!/usr/bin/env python3
"""Generate and export compact TPC-DS SQL64 chain datasets by scale factor."""
...
from export_query64_join_tree import export_case, scale_label
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Prepare TPC-DS SQL64 chain projected datasets.")
